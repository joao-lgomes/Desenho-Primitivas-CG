...
public class DesenhoPoligonos2 implements GLEventListener {
...
//AS BORDAS DE UM POLÍGONO NÃO PODEM HAVER INTERSEÇÕES E OS POLÍGONOS DEVEM SER CONVEXOS
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        gl.glVertex2f(-10f, 15f);
        gl.glVertex2f(-10f, -30f);
        gl.glVertex2f(-45f, -30f);
        gl.glVertex2f(-45f, 15f);
        gl.glEnd();

        gl.glBegin(GL.GL_LINE_LOOP);
        gl.glVertex2f(-10f, 15f);
        gl.glVertex2f(40f, 30f);
        gl.glVertex2f(40f, -15f);
        gl.glVertex2f(-10f, -30f);
        gl.glEnd();

        gl.glLineWidth(5f);
        gl.glBegin(GL.GL_LINE_LOOP);
        gl.glVertex2f(-8f, 15f);
        gl.glVertex2f(-27.5f, 37.5f);
        gl.glVertex2f(-47f, 15f);
        gl.glEnd();

        gl.glBegin(GL2.GL_QUADS);
        gl.glVertex2f(-8f, 15f);
        gl.glVertex2f(42f, 30.5f);
        gl.glVertex2f(21.5f, 53f);
        gl.glVertex2f(-27.5f, 37.5f);
        gl.glEnd();

        gl.glBegin(GL2.GL_QUADS);
        gl.glVertex2f(-21.5f, -30f);
        gl.glVertex2f(-21.5f, 5f);
        gl.glVertex2f(-33.5f, 5f);
        gl.glVertex2f(-33.5f, -30f);
        gl.glEnd();

        gl.glBegin(GL2.GL_QUADS);
        gl.glVertex2f(2.5f, 9f);
        gl.glVertex2f(27.5f, 18f);
        gl.glVertex2f(27.5f, -0.5f);
        gl.glVertex2f(2.5f, -9.5f);
        gl.glEnd();
    ...
    public static void main(String[] args) {
        ...
        canvas.addGLEventListener(new DesenhoPoligonos2());
